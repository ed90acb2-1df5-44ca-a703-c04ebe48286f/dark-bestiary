...
namespace DarkBestiary
{
    ...
    {
        [SerializeField] private List<AnimationSoundInfo> sounds = new List<AnimationSoundInfo>();
        ...
        {
            var animationSoundInfo = this.sounds.FirstOrDefault(s => s.Animation == animation);
