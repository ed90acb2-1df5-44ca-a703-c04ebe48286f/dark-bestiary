...
namespace DarkBestiary.Extensions
{
    public static class GameObjectExtensions
    {
        ...
        public static void DestroyAsVisualEffect(this GameObject gameObject)
        {
            ...
            Timer.Instance.Wait(particles.main.duration, () => { Object.Destroy(gameObject); });
        }
        ...
        {
            return gameObject.IsEnemyOf(Container.Instance.Resolve<CharacterManager>().Character.Entity);
        }
