...
namespace DarkBestiary.Data.Readers.Json
{
    public class EffectJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            if (type == nameof(VisionRevealMapEffect)) return json.ToObject<VisionRevealMapEffectData>(serializer);
            if (type == nameof(VisionAddSanityEffect)) return json.ToObject<VisionSanityEffectData>(serializer);
            if (type == nameof(VisionRemoveSanityEffect)) return json.ToObject<VisionSanityEffectData>(serializer);
            if (type == nameof(VisionCompleteRandomEffect)) return json.ToObject<EmptyEffectData>(serializer);
