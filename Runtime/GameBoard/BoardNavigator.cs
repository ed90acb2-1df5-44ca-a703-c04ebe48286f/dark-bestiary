...
namespace DarkBestiary.GameBoard
{
    ...
    {
        public static BoardNavigator Instance => s_Instance ??= new BoardNavigator(Board.Instance);
        private static BoardNavigator s_Instance;
        ...
        {
            return OverlapSquare(center, radius);
        ...
        {
            var index = column * Board.Width + row;
            return Board.Cells.IndexInBounds(index) ? Board.Cells[index] : null;
        }
