...
namespace DarkBestiary.Skills
{
    public class Skill
    {
        public static event Action<SkillUseEventData> AnySkillUsing;
        public static event Action<SkillUseEventData> AnySkillUsed;

        public const int c_DefaultWeaponSkillId = 252;

        public static readonly Skill s_Empty = new(-1, I18N.Instance.Get("Empty"));

        public event Action<SkillUseEventData> Using;
        public event Action<SkillUseEventData> Used;
        public event Action<Skill> PriceUpdated;
        public event Action<Skill> CooldownStarted;
        public event Action<Skill> CooldownUpdated;
        ...
        public List<SkillSet> Sets { get; set; } = new();
        ...
        private readonly List<Currency> m_Price;
        private readonly Dictionary<ResourceType, float> m_BaseCost;
        private readonly int m_BaseRangeMax;

        private float m_PriceMultiplier = 1;
        ...
        public Skill(SkillData data, Effect effect, List<Currency> price)
        {
            ...
            m_Price = price;
            m_BaseCost = data.ResourcesCosts;
            m_BaseRangeMax = data.RangeMax;
        }
        ...
        {
            return Id == c_DefaultWeaponSkillId;
        }

        public static bool IsLearnable(SkillType type, SkillFlags flags)
        {
        ...
        public bool IsMatchingSearchTerm(string term)
        {
            return Name.Contains(term) ||
                   ...
                   Sets.Any(s => s.Name.Contains(term));
        }
        ...
        public int GetMaxRange()
        {
            ...
            return m_BaseRangeMax + extraRange;
        }
        ...
        {
            return m_BaseCost.GetValueOrDefault(resourceType, 0);
        }
        ...
        public Dictionary<ResourceType, float> GetCost()
        {
            ...
            cost.Add(ResourceType.Rage, m_BaseCost.GetValueOrDefault(ResourceType.Rage, 0));
