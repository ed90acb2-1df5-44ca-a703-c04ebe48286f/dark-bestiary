...
namespace DarkBestiary.Scenarios.Encounters
{
    ...
    {
        public static event Action<CombatEncounter> AnyCombatStarted;
        public static event Action<CombatEncounter> AnyCombatEnded;
        public static event Action<CombatEncounter> AnyCombatRoundStarted;
        public static event Action<CombatEncounter> AnyCombatTeamTurnStarted;
        public static event Action<CombatEncounter> AnyCombatTeamTurnEnded;
        public static event Action<GameObject> AnyCombatTurnStarted;
        public static event Action<GameObject> AnyCombatTurnEnded;

        public static CombatEncounter Active { get; private set; }
        public List<GameObject> Queue { get; } = new();
