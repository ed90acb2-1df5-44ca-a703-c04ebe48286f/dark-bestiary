...
namespace DarkBestiary.Components
{
    ...
    {
        public event Payload<TalentsComponent, Talent> AnyTalentLearned;
        public event Payload<TalentsComponent, Talent> AnyTalentUnlearned;
        public event Payload<TalentsComponent> PointsChanged;
