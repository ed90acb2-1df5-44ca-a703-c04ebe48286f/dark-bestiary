...
namespace Utils
{
    ...
    public class OperationSum : IValue
    {
        ...
        public double Value
        {
            get { return this.m_Values.Select(v => v.Value).Sum(); }
        }
        ...
        public override string ToString()
        {
            return "( " + string.Join(" + ", this.m_Values.Select(v => v.ToString()).ToArray()) + " )";
        }
    }
    public class OperationProduct : IValue
    {
        ...
        public double Value
        {
            get { return this.m_Values.Select(v => v.Value).Aggregate((v1, v2) => v1 * v2); }
        }
    ...
    public class MultiParameterList : IValue
    {
        ...
        public double Value
        {
            get { return this.m_Values.Select(v => v.Value).FirstOrDefault(); }
        }
    ...
    public class CustomFunction : IValue
    {
        ...
        public double Value
        {
            get
            {
                ...
                return this.m_Delegate(this.m_Params.Select(p => p.Value).ToArray());
            }
        }
        ...
        public override string ToString()
        {
            if (this.m_Params == null)
                return this.m_Name;
            return this.m_Name + "( " + string.Join(", ", this.m_Params.Select(v => v.ToString()).ToArray()) + " )";
        }
    }
    ...
    public class ExpressionParser
    {
        ...
        public ExpressionParser()
        {
            ...
            this.m_Consts.Add("PI", () => System.Math.PI);
            this.m_Consts.Add("e", () => System.Math.E);
            this.m_Funcs.Add("sqrt", (p) => System.Math.Sqrt(p.FirstOrDefault()));
            this.m_Funcs.Add("abs", (p) => System.Math.Abs(p.FirstOrDefault()));
            this.m_Funcs.Add("ln", (p) => System.Math.Log(p.FirstOrDefault()));
            this.m_Funcs.Add("floor", (p) => System.Math.Floor(p.FirstOrDefault()));
            this.m_Funcs.Add("ceiling", (p) => System.Math.Ceiling(p.FirstOrDefault()));
            this.m_Funcs.Add("round", (p) => System.Math.Round(p.FirstOrDefault()));

            this.m_Funcs.Add("sin", (p) => System.Math.Sin(p.FirstOrDefault()));
            this.m_Funcs.Add("cos", (p) => System.Math.Cos(p.FirstOrDefault()));
            this.m_Funcs.Add("tan", (p) => System.Math.Tan(p.FirstOrDefault()));

            this.m_Funcs.Add("asin", (p) => System.Math.Asin(p.FirstOrDefault()));
            this.m_Funcs.Add("acos", (p) => System.Math.Acos(p.FirstOrDefault()));
            this.m_Funcs.Add("atan", (p) => System.Math.Atan(p.FirstOrDefault()));
            this.m_Funcs.Add("atan2", (p) => System.Math.Atan2(p.FirstOrDefault(),p.ElementAtOrDefault(1)));
            //System.Math.Floor
            this.m_Funcs.Add("min", (p) => System.Math.Min(p.FirstOrDefault(), p.ElementAtOrDefault(1)));
            this.m_Funcs.Add("max", (p) => System.Math.Max(p.FirstOrDefault(), p.ElementAtOrDefault(1)));
            this.m_Funcs.Add("rnd", (p) =>
            {
                if (p.Length == 2)
        ...
        public void AddFunc(string aName, System.Func<double[],double> aMethod)
        {
            if (this.m_Funcs.ContainsKey(aName))
                ...
                this.m_Funcs.Add(aName, aMethod);
        }
        ...
        public void AddConst(string aName, System.Func<double> aMethod)
        {
            if (this.m_Consts.ContainsKey(aName))
                ...
                this.m_Consts.Add(aName, aMethod);
        }
        ...
        IValue Parse(string aExpression)
        {
            ...
            double doubleValue;
            if (double.TryParse(aExpression, NumberStyles.Float, CultureInfo.InvariantCulture.NumberFormat, out doubleValue))
            {
