...
namespace DarkBestiary.Managers
{
    ...
    {
        public static readonly Dictionary<KeyType, KeyCode> Default = new Dictionary<KeyType, KeyCode>()
        {
            ...
            {KeyType.Specializations, KeyCode.I},
        ...
        public static event Payload<KeyType, KeyCode> KeyBindingChanged;
        public static event Payload<Dictionary<KeyType, KeyCode>> KeyBindingsChanged;
        ...
        {
            SettingsManager.Instance.Data.KeyBindings = Default;
        ...
        public static KeyCode Get(KeyType type)
        {
            ...
            {
                SettingsManager.Instance.Data.KeyBindings.Add(type, Default[type]);
                KeyBindingChanged?.Invoke(type, Default[type]);
            }
