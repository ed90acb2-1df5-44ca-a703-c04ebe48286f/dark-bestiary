...
namespace DarkBestiary.UI.Elements
{
        ...
        IPointerEnterHandler, IPointerExitHandler, IPointerUpHandler, IPointerDownHandler
    {
        ...
        public event Payload<SkillSlotView> PointerUp;
        public event Payload<SkillSlotView> PointerEnter;
        public event Payload<SkillSlotView> PointerExit;
        ...
        public void SetHotkey(KeyCode hotkey)
        {
            ...
            this.hotkeyText.text = EnumTranslator.Translate(this.hotkey);
        }
        ...
        private void UpdateCost()
        {
            ...
            this.costText.transform.parent.gameObject.SetActive(cost >= 1);
            this.costText.text = cost.ToString("F0");
        }
        ...
        private void Update()
        {
            if (this.hotkey == KeyCode.None || UIManager.Instance.IsAnyFullscreenUiOpen())
            {
                return;
            }
